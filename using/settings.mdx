---
title: "Configuring kChat Settings and Preferences"
sidebarTitle: "Settings"
description: "Change your username, switch between built-in themes, or apply a custom CSS stylesheet from the kChat Settings page."
---
...
If no theme has ever been selected, `settings.js` automatically applies a default theme on first load based on your system preference — `default-dark.css` for dark mode and `default-light.css` for light mode, detected via `prefers-color-scheme`.
