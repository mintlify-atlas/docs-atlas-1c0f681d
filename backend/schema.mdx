---
title: "kChat Supabase Schema: rooms, messages, and profiles Tables"
sidebarTitle: "Schema"
description: "Complete reference for kChat's three Supabase tables — rooms, messages, and profiles — including column types, default values, and foreign key constraints."
---
