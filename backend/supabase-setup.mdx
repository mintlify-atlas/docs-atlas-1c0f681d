---
title: "Configure Supabase as the kChat Backend"
sidebarTitle: "Supabase Setup"
description: "Set up a free Supabase project, run the kChat schema, and connect the app to your database using the Supabase JavaScript client."
---
